...
describe('Gilded Rose', () => {
  ...
  test('decrease quality of Item by 2 when past use-by date', () => {
  ...
  test('do not degrade Item quality below zero', () => {
  ...
  test('do not degrade Hand of Rag', () => {
    const GildedRose = new Shop([new Item(Specials.Lego, 0, 0)]);
    const items = GildedRose.updateQuality();
    expect(items[0].quality).toEqual(80);
  });

  test('increase Aged Brie quality', () => {
  ...
  test('increase Aged Brie quality twofold when past use-by date', () => {
  ...
  test('increase Backstage Pass quality by default', () => {
  ...
  test('increase Backstage Pass quality by 2 within 10 days', () => {
